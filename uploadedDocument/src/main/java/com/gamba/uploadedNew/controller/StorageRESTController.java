package com.gamba.uploadedNew.controller;
...
import com.gamba.uploadedNew.uploadFile.StorageService;
...
//	}
	...
	public ResponseEntity<Resource> showFile(@PathVariable String filename){
		...
		return ResponseEntity.ok()
				.header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filenane='" + file.getFilename() + "'")
				.body(file);
	}
