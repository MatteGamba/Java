...
public class StudenteCtrl {
	...
	public void deleteStudenteByMath(int nMat) {
		Studente s = getStudenteByMat(nMat); //richiamo un metodo già creato
		if(s != null) {
			System.out.println("Vuoi eliminire lo studente " + s + "?");
		}
	}
}
